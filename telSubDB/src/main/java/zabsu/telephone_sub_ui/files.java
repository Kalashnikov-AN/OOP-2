 ...
 * <p>
 * Формат текстового файла: каждая запись - поля объекта TelSub с разделителем ";".
 * Каждый объект записывается на отдельной строке
 * Пример: +8(800)000-00-00;123456;Based;Andrew;12.0
 * <p>
 */
public class files {

    /**
     * Сохраняет записи(экземпляры класса TelSub) базы данных в файл.
     * <p>
